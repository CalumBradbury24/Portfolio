    ...
    return (
      <div className="Portfolio">
        ...
        <div className="options">
          <h4 className={"option orange " + (option === 'All' ? 'stayOrange' : 'default')} onClick={this.handleClick("All")}>
            All
          </h4>
          <h4 className={"option blue " + (option === 'WebApp' ? 'stayBlue' : 'default')} onClick={this.handleClick("WebApp")}>
            Web Applications
          </h4>
          <h4 className={"option green " + (option === 'Other' ? 'stayGreen' : 'default')}  onClick={this.handleClick("Other")}>
            Other
          </h4>
        </div>
